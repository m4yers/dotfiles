...
defaults write NSGlobalDomain AppleLanguages -array "en" "nl" "ru" "ua"
...
sudo defaults write /.Spotlight-V100/VolumeConfiguration Exclusions -array "/Volumes" "~/Development"
