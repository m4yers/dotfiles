...
composed as ``<namespace-slug>/files`` so file-summary blobs sit
...
from io_types import OverviewIngestInput, OverviewIngestOutput
...
def overview_ingest(inp: OverviewIngestInput) -> OverviewIngestOutput:
