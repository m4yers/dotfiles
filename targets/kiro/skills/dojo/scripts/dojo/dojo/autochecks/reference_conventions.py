...
@rule('references/reference-conventions.md:60')
def rule_4_4_file_length(
...
@rule('references/reference-conventions.md:69')
...
@rule('references/reference-conventions.md:71')
...
@rule('references/reference-conventions.md:73')
...
@rule('references/reference-conventions.md:25')
