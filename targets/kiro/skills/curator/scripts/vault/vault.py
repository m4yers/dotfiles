...
The vault root defaults to ~/Obsidian/MahVault/ and can be
overridden with the CURATOR_VAULT_ROOT environment variable. All
vault-relative paths in JSON output are relative to this root.
"""
