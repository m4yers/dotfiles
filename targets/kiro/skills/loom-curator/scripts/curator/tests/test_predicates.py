...
CASES = [
    ...
    # podcast/talk are in rules but not in media vocabulary — skip per spec
    ('guests-interview', {'media': 'podcast', 'form': 'interview'}, {'media': 'paper', 'form': 'research'}),
    ('guests-roundtable', {'media': 'podcast', 'form': 'roundtable'}, {'media': 'paper', 'form': 'research'}),
    ('quotes-podcast', {'media': 'podcast', 'form': 'interview'}, {'media': 'book', 'form': 'textbook'}),
    ('quotes-news', {'media': 'article', 'form': 'news'}, {'media': 'book', 'form': 'textbook'}),
    ('key_points-lecture', {'media': 'video', 'form': 'lecture'}, {'media': 'book'}),
    ('key_points-keynote', {'media': 'talk', 'form': 'keynote'}, {'media': 'book'}),
    ('key_points-videotalk', {'media': 'video', 'form': 'talk'}, {'media': 'book'}),
    ('speaker-keynote', {'media': 'talk', 'form': 'keynote'}, {'media': 'video', 'form': 'lecture'}),
