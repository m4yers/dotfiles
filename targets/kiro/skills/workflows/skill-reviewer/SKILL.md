...
Audit skills in `~/.kiro/skills/` for quality, formatting, and
convention compliance.

## Prerequisites

- Read
  `~/.kiro/skills/workflows/skill-builder/references/conventions.md`
...
| Completion status section    | Has `## Completion` with status table |
...
| Status               | Criteria                             |
|----------------------|--------------------------------------|
| `DONE`               | All checks run, report presented     |
| `DONE_WITH_CONCERNS` | Review done but some files unreadable|
